...
Only requiring some minor changes is corvus.cpp.
...
Changes to corvus.cpp
----------------------
corvus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
