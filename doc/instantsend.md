...
This mechanism has been integrated into Bitcore-Node-Corvus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/corvuspay/insight-api-corvus#web-socket-api](https://github.com/corvuspay/insight-api-corvus#web-socket-api)
* API: [https://github.com/corvuspay/insight-api-corvus#instantsend-transactions](https://github.com/corvuspay/insight-api-corvus#instantsend-transactions)
...
By default, the Corvus Glaive daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Corvus Glaive daemon:
