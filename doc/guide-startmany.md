...
[From the corvus github repo](https://github.com/corvuspay/corvus/blob/master/doc/masternode_conf.md)
...
## Update corvus.conf on server

If you generated a new masternode private key, you will need to update the remote `corvus.conf` files.

Shut down the daemon and then edit the file.

```nano .corvuscore/corvus.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `corvus.conf` file.
...
and comparing with the official explorer at https://explorer.corvus.org/chain/Corvus
...
Search your Masternodes on https://corvusninja.pl/masternodes.html
