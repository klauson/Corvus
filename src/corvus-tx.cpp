...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Corvus Glaive corvus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  corvus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded corvus transaction") + "\n" +
              "  corvus-tx [options] -create [commands]   " + _("Create hex-encoded corvus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded corvus transaction
