...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CorvusNetwork") type = CorvusNetwork;
    if(strType == "CorvusNetworkVariable") type = CorvusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CorvusNetwork) s = "CorvusNetwork";
    if(type == CorvusNetworkVariable) s = "CorvusNetworkVariable";
