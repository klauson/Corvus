 ...
 *
 *   // network
 *   CCorvusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.corvus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCorvusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CorvusNetwork
// //   -- signature requirements : Key1(User)
// class CCorvusNetworkVariable : public CGovernanceObject
// {
// private:
