    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Corvus Glaive") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Corvus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and corvus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Corvus Glaive"), this);
    aboutAction->setStatusTip(tr("Show information about Corvus Glaive"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Corvus Glaive"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Corvus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Corvus addresses"));
    ...
    openAction->setStatusTip(tr("Open a corvus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Corvus Glaive help message to get a list with possible Corvus Glaive command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Corvus Glaive client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Corvus network", "", count));
    } else {
...
{
    QString strTitle = tr("Corvus Glaive"); // default title
