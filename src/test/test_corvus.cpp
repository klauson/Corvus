...
#define BOOST_TEST_MODULE Corvus Test Suite

#include "test_corvus.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_corvus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
