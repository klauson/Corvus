...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Corvus related functionality
...
/*
    ...
    allow endless transaction that would bloat Corvus and make it unusable. To
...
{
    if(fLiteMode) return; // disable all Corvus specific functionality
